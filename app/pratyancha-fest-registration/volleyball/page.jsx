...
export default function VolleyballRegistration() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await fetch("https://sac.iitram.in/api/volleyball_registration.php", {
                method: "POST",
                headers: {
                    ...
                    >
                        <div className="flex items-center justify-center gap-4 text-sm font-athletic">
                            <div className="flex items-center gap-2">
                                ...
                                <span className="font-athletic" style={{ color: '#FFFFFF' }}>Registration Fee: ₹2,500 per team</span>
                            </div>
                            <div className="flex items-center gap-2">
