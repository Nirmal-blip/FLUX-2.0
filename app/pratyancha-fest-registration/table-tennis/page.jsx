...
export default function TableTennisRegistration() {
  ...
  // Table Tennis: 3 Required + 2 Optional = 5 Total
  ...
  const validateForm = () => {
    ...
    formData.players.forEach((player, index) => {
      // Validate required players (First 3)
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Pointing to the new Table Tennis PHP API
      const response = await fetch(
        "https://sac.iitram.in/api/tabletennis_registration.php",
        {
          method: "POST",
          ...
          <div className="max-w-4xl mx-auto">
            ...
            >
              ...
              >
                {isGoingBack ? (
                  <>
                    <ClipLoader color="#06B6D4" size={16} />
              ...
              <motion.h1
                ...
                style={{
                  background:
                    "linear-gradient(135deg, #06B6D4 0%, #F97316 50%, #06B6D4 100%)",
                  backgroundClip: "text",
              ...
              <motion.div
                ...
                className="mt-6 p-4 rounded-xl border border-cyan-400/30 bg-cyan-500/10 backdrop-blur-sm"
              >
            ...
            >
              ...
              >
                ...
                >
                  ...
                  Player List (3 Required + 2 Optional Substitutes)
                </h2>
