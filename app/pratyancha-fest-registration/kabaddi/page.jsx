...
export default function KabaddiRegistration() {
  ...
  // Kabaddi: 7 on field + subs. Total 12 allowed.
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Pointing to the new Kabaddi PHP API
      const response = await fetch(
        "https://sac.iitram.in/api/kabaddi_registration.php",
        {
          method: "POST",
          ...
          <div className="max-w-4xl mx-auto">
            ...
            >
              ...
              <motion.div
                ...
                className="mt-6 p-4 rounded-xl border border-red-400/30 bg-red-500/10 backdrop-blur-sm"
              >
            ...
            >
              ...
              >
                ...
                >
                  ...
                  Player List (7 Required + 5 Optional Substitutes)
                </h2>
